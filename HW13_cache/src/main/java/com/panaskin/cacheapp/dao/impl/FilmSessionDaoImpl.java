package com.panaskin.cacheapp.dao.impl;
...
public class FilmSessionDaoImpl implements FilmSessionDao {
    ...
    public void addFilmSession(FilmSession filmSession) {
        ...
        try {
            ...
            System.out.println("Can't find film session" + e);
        } finally {
            session.close();
        }
    }
    ...
    public void updateFilmSession(String filmSessionId, FilmSession filmSession) {
        ...
        try {
            transaction = session.beginTransaction();
            FilmSession oldFilmSession = session.get(FilmSession.class, filmSession.getUuid());
